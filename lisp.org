...
#+BEGIN_SRC lisp
    ...
    (let* ((c (sphere-center s))
           (n (minroot (+ (sq (lm:x (ray-direction r))) (sq (lm:y (ray-direction r))) (sq (lm:z (ray-direction r))))
                       ...
                       (+ (sq (- (point-x (ray-origin r)) (point-x c)))
                          ...
                          (- (sq (sphere-radius s)))))))
      (if n
          (make-instance 'point :x (+ (point-x (ray-origin r)) (* (- n 0.0000000001) (lm:x (ray-direction r))))
  ...
  (defun init-scene ()
    (let ((srfcs nil)
      ...
      (push (make-light :position (make-instance 'point :x 0 :y -350 :z -950)) lghts)
      (make-scene :eye (make-instance 'point :x 0 :y 0 :z 200) :surfaces srfcs :lights lghts)))
