...
#+BEGIN_SRC lisp
  ...
  (defclass point ()
    ((x :initarg :point-x :accessor point-x)
     ...
     (z :initarg :point-z :accessor point-z)))
  ...
  (defclass surface ()
    ((color :initarg :surface-color :accessor surface-color)))
  ...
  (defclass plane (surface)
    ((normal   :initarg :plane-normal    :accessor plane-normal)
     (distance :initarg :plane-distance  :accessor plane-distance)))
  ...
  (defclass scene ()
    ((eye      :initarg :scene-eye       :accessor scene-eye)
     (surfaces :initarg :scene-surfaces  :accessor scene-surfaces)
     (lights   :initarg :scene-lights    :accessor scene-lights)))

  (defclass ray ()
    ((origin    :initarg :ray-origin     :accessor ray-origin)
     (direction :initarg :ray-direction  :accessor ray-direction)))
  ...
  (defmethod intersect ((s sphere) r)
    (let* ((c (sphere-center s))
      ...
      (if n
          (make-instance
           'point
           :point-x (+ (point-x (ray-origin r)) (* (- n 0.0000000001) (lm:x (ray-direction r))))
           :point-y (+ (point-y (ray-origin r)) (* (- n 0.0000000001) (lm:y (ray-direction r))))
           :point-z (+ (point-z (ray-origin r)) (* (- n 0.0000000001) (lm:z (ray-direction r))))))))
