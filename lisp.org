...
#+BEGIN_SRC lisp
  ...
  (defun init-scene ()
    (let ((srfcs nil)
          (lghts nil))
      (push (create-plane 0 1 .001 380 1) srfcs)
      (push (create-plane 1 0 .001 800 1) srfcs)
      (push (create-plane -1 0 .001 800 1) srfcs)
      (push (create-plane 0 -1 .001 800 1) srfcs)
      (push (create-plane 0 0 0.001 3000 1) srfcs)
      (push (create-sphere 0 0 -2200 300 .9) srfcs)
      (do ((x -2 (1+ x)))
          ((> x 2))
        (do ((z 2 (1+ z)))
            ((> z 5))
  ...
  (render "ccc2223.png" (init-scene) 600 600 3)
#+END_SRC
