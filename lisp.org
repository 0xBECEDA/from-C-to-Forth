...
#+BEGIN_SRC lisp
  ...
  ;; почему-то time не показывает количество секунд, затраченных на исполнение функций
  (time (foo2 2 0))
  (time (foo 2))
...
#+BEGIN_SRC lisp
  ...
  ;; этот вектор показывает, сколько дней проходит от начала года
  ;; до соответствующего месяца
  (defconstant month
    #(0 31 59 90 120 151 181 212 243 273 304 334 365))

  ;; устанваливаем константу yzerop
  ;; ее значение - 2000ый год
  ...
  ;; арифметика дат
  ;; преобразует целое число в дату
  (defun num->date (n)
