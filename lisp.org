...
#+BEGIN_SRC lisp
  ...
  (block test
    (defstruct (node (:print-function
      ...
      elt (l nil) (r nil))
    ;;
    (defparameter mytree (make-array 10 :fill-pointer 0 :element-type 'node))
    ;;
    (dotimes (i 9)
